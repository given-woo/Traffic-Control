...
os.environ['PYTHONPATH'] = "/opt/homebrew/opt/sumo/share/sumo/tools"
...
class Simulation:
    def __init__(self, Model, Memory, TrafficGen, sumo_cmd, gamma, max_steps, yellow_duration, num_states, num_actions, training_epochs):
        self._Model = Model
        self._Memory = Memory
    ...
    def _get_state(self):
        ...
        for car_id in car_list:
            ...
            if valid_car:
                ...
                if lane_id[0:-2] in self._green_phase_roads():
                    gp+=1
                else:
                    rp+=1
